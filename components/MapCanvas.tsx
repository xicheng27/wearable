...
export default function MapCanvas({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-gray-100 bg-[#F2F6F3] ${className}`}
    >
      <svg
        viewBox={`0 0 ${W} ${H}`}
      ...
      >
        ...
        {places.map((p) => {
          ...
          return (
            ...
            >
              <circle r="16" fill="#1D9E75" opacity={isSelected ? 0.25 : 0.12}>
                {isSelected && (
