...
export const brands: Brand[] = [
  ...
  },
  {
    id: "june-adaptive",
    name: "June Adaptive",
    tagline: "Adaptive essentials for easier dressing",
    description:
      "June Adaptive offers individual adaptive garments, footwear and daily essentials designed around self-dressing, assisted dressing and seated comfort.",
    longDescription:
      "June Adaptive is a Canadian adaptive clothing retailer with products for women, men and children. Its range includes open-back tops, side-opening pants, adaptive sleepwear, wide footwear and socks. Product pages identify the relevant closures and dressing needs, helping shoppers compare individual items before contacting the brand about international delivery.",
    logo: "JA",
    heroColor: "#806B78",
    image: "",
    adaptiveFeatures: [
    ...
    styleTags: ["Casual", "Everyday", "Comfort", "Clean / minimal"],
    whoItSuits: [
      "People who use assisted dressing",
      "Wheelchair users",
    ...
    locations: [
      {
        name: "June Adaptive online store",
    ...
    shipping: {
      ...
      currency: "CAD",
      estimatedDays: "Contact the brand for international orders",
      returnsPolicy: "See June Adaptive for current return terms.",
    },
  ...
  },
  {
    id: "jam-the-label",
    name: "JAM the Label",
    tagline: "Fashion-forward clothing with adaptive access",
    description:
      "JAM the Label creates contemporary adaptive garments with magnetic closures, side access, seated comfort and sensory-conscious details.",
    longDescription:
      "JAM the Label is an Australian adaptive fashion brand focused on wearable, expressive clothing. Its individual product range includes magnetic shirts and jackets, side-access pants, easy-on bottoms, sensory socks and versatile layers. The brand provides a Singapore SGD storefront and international delivery options.",
    logo: "JAM",
    heroColor: "#63505C",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Pants", "Shorts", "Skirts", "Outerwear", "Socks"],
    styleTags: ["Streetwear", "Casual", "Sporty", "Smart casual"],
    whoItSuits: [
      "Wheelchair and seated wearers",
      "People using prosthetics or medical devices",
      "People with limited hand dexterity",
      "Sensory-sensitive wearers",
    ],
    locations: [
      {
        name: "JAM the Label online store",
        address: "Official online store",
        city: "Online",
        country: "Australia",
        type: "online-only",
    ...
    shipping: {
      countries: ["Australia", "Singapore", "Worldwide"],
      freeShippingThreshold: 150,
      currency: "SGD",
      estimatedDays: "See checkout for current destination estimate",
      returnsPolicy: "See JAM the Label for current return terms.",
    },
  ...
  },
  {
    id: "will-and-well",
    name: "Will & Well",
    tagline: "Inclusive fashion designed in Singapore",
    description:
      "Will & Well is a Singapore inclusive fashion label offering functional garments, adaptable closures and local tailoring services.",
    longDescription:
      "Will & Well designs inclusive clothing in Singapore with an emphasis on dignity, independence and personal style. Its individual garments include magnetic-snap shirts, front-zip dresses, adjustable pants and adaptable tops. The local store also offers bespoke tailoring and alterations, though only exact garments are included in the main product grid.",
    logo: "W&W",
    heroColor: "#8A6D55",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Shirts", "Pants", "Dresses", "Outerwear", "Shorts"],
    styleTags: ["Smart casual", "Clean / minimal", "Casual", "Formal"],
    whoItSuits: [
      "Singapore shoppers seeking local adaptive clothing",
      "People with limited hand dexterity",
      "People who need garment alterations",
      "Wearers seeking functional fashion",
    ],
    locations: [
      {
        name: "Will & Well Singapore",
        address: "Contact the brand for appointments and availability",
        city: "Singapore",
        country: "Singapore",
        type: "flagship",
      },
    ...
    shipping: {
      ...
      freeShippingThreshold: 150,
      currency: "SGD",
      estimatedDays: "See official store for current delivery estimate",
      returnsPolicy: "See Will & Well for current return and alteration terms.",
    },
  ...
  },
  {
    id: "silverts",
    name: "Silvert's",
    tagline: "Adaptive apparel for easier independent and assisted dressing",
    description:
      "Silvert's offers adaptive clothing, footwear and daily wear designed for older adults, wheelchair users, carers and people with limited mobility.",
    longDescription:
      "Silvert's is a specialist adaptive clothing brand with a broad catalogue of easy-on tops, open-back garments, side-zip pants, wheelchair-friendly bottoms, adaptive sleepwear and footwear. Its products are designed around independent dressing, assisted dressing and comfort for people with mobility, dexterity and age-related needs.",
    logo: "SV",
    heroColor: "#6E5B7D",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Pants", "Dresses", "Nightwear", "Footwear", "Outerwear"],
    styleTags: ["Everyday", "Classic", "Comfort", "Casual"],
    whoItSuits: [
      "Older adults and carers",
      "People who use assisted dressing",
      "Wheelchair users",
    ...
    shipping: {
      ...
      currency: "USD",
      estimatedDays: "See checkout for current delivery estimates",
      returnsPolicy: "See Silvert's for current return terms.",
    },
  ...
  },
  {
    id: "joe-and-bella",
    name: "Joe & Bella",
    tagline: "Modern adaptive clothing for older adults",
    description:
      "Joe & Bella designs polished adaptive clothing and care-ready garments for older adults, carers and people who want easier dressing without a medical look.",
    longDescription:
      "Joe & Bella focuses on modern adaptive clothing for older adults and people who need dressing support. Its catalogue includes easy-on pants, magnetic tops, adaptive layers and care-friendly clothing intended to look like mainstream apparel while simplifying dressing routines.",
    logo: "J&B",
    heroColor: "#4E6A65",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Shirts", "Pants", "Outerwear", "Nightwear"],
    styleTags: ["Classic", "Smart casual", "Everyday", "Comfort"],
    whoItSuits: [
      "Older adults who want mainstream-looking clothing",
      "People with limited hand dexterity",
      "Carers supporting daily dressing",
      "People with Parkinson's or mobility changes",
    ],
    locations: [
      {
        name: "Joe & Bella online store",
        address: "Official online store",
        city: "Online",
        country: "USA",
        type: "online-only",
    ...
    shipping: {
      ...
      currency: "USD",
      estimatedDays: "See checkout for current delivery estimates",
      returnsPolicy: "See Joe & Bella for current return terms.",
    },
  ...
  },
  {
    id: "the-able-label",
    name: "The Able Label",
    tagline: "Discreet adaptive clothing with touch-and-close fastenings",
    description:
      "The Able Label creates discreet adaptive clothing for women and men, with touch-and-close fastenings, pull-on designs and easy dressing details.",
    longDescription:
      "The Able Label is a UK adaptive clothing brand built around subtle easy-dressing details. Its range includes VELCRO brand fastening shirts, pull-on trousers, adaptive dresses, nightwear, underwear and footwear. The brand is especially useful for older adults, carers and people living with arthritis, Parkinson's, stroke recovery or reduced dexterity.",
    logo: "TAL",
    heroColor: "#7C6372",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Shirts", "Pants", "Dresses", "Nightwear", "Underwear", "Footwear"],
    styleTags: ["Classic", "Everyday", "Comfort", "Smart casual"],
    whoItSuits: [
      "People with arthritis or tremors",
      "Older adults who need discreet adaptive clothing",
      "Carers assisting with dressing",
      "People recovering from stroke",
    ],
    locations: [
      {
        name: "The Able Label online store",
        address: "Official online store",
        city: "Online",
        country: "UK",
        type: "online-only",
    ...
    shipping: {
      ...
      currency: "GBP",
      estimatedDays: "See checkout for current delivery estimates",
      returnsPolicy: "See The Able Label for current return terms.",
    },
  ...
  },
  {
    id: "buck-and-buck",
    name: "Buck & Buck",
    tagline: "Adaptive clothing for seniors and assisted dressing",
    description:
      "Buck & Buck offers adaptive clothing for seniors, care homes and people who need easier independent or assisted dressing.",
    longDescription:
      "Buck & Buck carries a large adaptive apparel catalogue for seniors and care settings. Products include open-back tops, side-zip pants, pull-on trousers, easy-care dresses, adaptive sleepwear and wheelchair-friendly garments designed to simplify dressing and changing.",
    logo: "B&B",
    heroColor: "#7B5F4D",
    image: "",
    adaptiveFeatures: [
    ...
    clothingTypes: ["Tops", "Pants", "Dresses", "Nightwear", "Outerwear"],
    styleTags: ["Classic", "Everyday", "Comfort", "Casual"],
    whoItSuits: [
      "Seniors and care-home residents",
      "Carers supporting assisted dressing",
      "Wheelchair users",
      "People who need easy-care adaptive garments",
    ],
    locations: [
      {
        name: "Buck & Buck online store",
        address: "Official online store",
        city: "Online",
        country: "USA",
        type: "online-only",
    ...
    shipping: {
      ...
      currency: "USD",
      estimatedDays: "See checkout for current delivery estimates",
      returnsPolicy: "See Buck & Buck for current return terms.",
    },
