...
export const adaptiveBrands: AdaptiveBrand[] = [
  ...
  },
  {
    ...
    name: "Werable",
    country: "Singapore",
    website: "https://werable.co/",
    singaporeAvailability: "Singapore-based brand",
    shippingNotes: "Singapore brand; confirm shipping and stock on the brand site.",
    categories: ["Women", "Dresses", "Tops", "Accessories"],
    adaptiveFocus: [
      "one-handed dressing",
      "magnetic closures",
      "post-surgery",
    ...
    notes:
      "Singapore adaptive fashion label focused on one-arm dressing, magnetic closures and post-surgery friendly wear. Exact product pages, prices and images were not independently verified in this build.",
  },
  {
    id: "can-care",
    name: "Can-Care",
    country: "Singapore",
    website: "https://cancare.asia/",
    singaporeAvailability: "Singapore retailer (post-cancer care)",
    shippingNotes: "Singapore-based retailer; confirm shipping on the retailer site.",
    categories: ["Mastectomy bras", "Post-surgery wear", "Compression"],
    adaptiveFocus: [
      "mastectomy-friendly",
      "post-surgery",
      "post-cancer care",
    ...
    notes:
      "Singapore/Asia post-cancer care retailer carrying mastectomy-friendly and post-surgery products. Exact product pages, prices and images were not independently verified in this build.",
  },
  {
    id: "seniorcare-sg",
    name: "SeniorCare",
    country: "Singapore",
    website: "https://www.seniorcare.com.sg/",
    singaporeAvailability: "Singapore retailer (elderly care)",
    shippingNotes: "Singapore online store; confirm shipping on the retailer site.",
    categories: ["Elderly clothing", "Easy-dressing wear", "Adaptive basics"],
    adaptiveFocus: [
      "elderly dressing",
      "easy dressing",
      "carers",
    ...
    notes:
      "Singapore online elderly-care store carrying adaptive and easy-dressing clothing. Exact product pages, prices and images were not independently verified in this build.",
  },
  {
    id: "silverts",
    name: "Silvert's",
    ...
    singaporeAvailability: "Singapore availability unknown — check international shipping",
    shippingNotes:
      "Long-established adaptive/elderly brand; international shipping to Singapore not confirmed here.",
    categories: [
      "Adaptive tops",
      "Adaptive trousers",
      "Footwear",
    ...
    adaptiveFocus: [
      "elderly dressing",
      "wheelchair / seated wear",
      "easy dressing",
      "diabetic-friendly socks",
      "orthopaedic-friendly footwear",
    ],
    notes:
      "Established North American adaptive/senior clothing retailer. Mark Singapore shipping as unknown until confirmed. Exact product pages, prices and images were not independently verified in this build.",
  },
  {
    id: "joe-and-bella",
    name: "Joe & Bella",
    country: "United States",
    website: "https://www.joeandbella.com/",
    singaporeAvailability: "Singapore availability unknown — check international shipping",
    shippingNotes:
      "US adaptive brand for seniors and caregivers; international shipping to Singapore not confirmed here.",
    categories: ["Adaptive tops", "Adaptive bottoms", "Loungewear"],
    adaptiveFocus: [
      "elderly dressing",
      "caregiver-friendly",
      "easy dressing",
    ...
    notes:
      "US adaptive clothing brand designed for older adults and caregivers. Mark Singapore shipping as unknown until confirmed. Exact product pages, prices and images were not independently verified in this build.",
  },
];
...
export const adaptiveProducts: AdaptiveProduct[] = [
  ...
  {
    id: "werable-adaptive-collection",
    brandId: "werable",
    brandName: "Werable",
    name: "One-Arm & Magnetic-Closure Collection",
    productType: "Collection",
    gender: "Women",
    category: "Adaptive Clothing",
    productUrl: "https://werable.co/",
    imageUrl: null,
    singaporeAvailability: "Singapore-based brand",
    adaptiveFeatures: ["One-handed dressing", "Magnetic closures", "Post-surgery friendly"],
    bestFor: ["Limb difference", "Post-surgery", "One-handed dressing"],
    closureType: "Magnetic",
    countryAvailability: ["Singapore"],
    sourceNotes:
      "Brand-level listing for a Singapore adaptive label. Exact product page, price and image not independently verified in this build; link opens the brand site.",
  },
  {
    id: "can-care-mastectomy-collection",
    brandId: "can-care",
    brandName: "Can-Care",
    name: "Mastectomy & Post-Surgery Range",
    productType: "Collection",
    gender: "Women",
    category: "Post-Surgery Wear",
    productUrl: "https://cancare.asia/",
    imageUrl: null,
    singaporeAvailability: "Singapore retailer",
    adaptiveFeatures: ["Pocketed mastectomy bras", "Post-surgery comfort"],
    bestFor: ["Post-cancer care", "Mastectomy", "Post-surgery"],
    countryAvailability: ["Singapore"],
    sourceNotes:
      "Brand-level listing for a Singapore post-cancer care retailer. Exact product page, price and image not independently verified in this build; link opens the retailer site.",
  },
  {
    id: "seniorcare-sg-easy-dressing-collection",
    brandId: "seniorcare-sg",
    brandName: "SeniorCare",
    name: "Elderly Easy-Dressing Clothing",
    productType: "Collection",
    gender: "Unisex",
    category: "Elderly Clothing",
    productUrl: "https://www.seniorcare.com.sg/",
    imageUrl: null,
    singaporeAvailability: "Singapore retailer",
    adaptiveFeatures: ["Easy dressing", "Carer-friendly"],
    bestFor: ["Elderly users", "Carers", "Seated wear"],
    countryAvailability: ["Singapore"],
    sourceNotes:
      "Brand-level listing for a Singapore elderly-care retailer. Exact product page, price and image not independently verified in this build; link opens the retailer site.",
  },
  {
    id: "silverts-adaptive-collection",
    brandId: "silverts",
    brandName: "Silvert's",
    name: "Adaptive & Senior Clothing Range",
    productType: "Collection",
    gender: "Unisex",
    category: "Adaptive Clothing",
    productUrl: "https://www.silverts.com/",
    imageUrl: null,
    singaporeAvailability: "Singapore availability unknown",
    adaptiveFeatures: ["Open-back tops", "Side-opening trousers", "Easy-on footwear"],
    bestFor: ["Elderly users", "Wheelchair / seated wear", "Orthopaedic needs"],
    sourceNotes:
      "Brand-level listing for an established North American adaptive retailer. Singapore shipping unknown; exact product page, price and image not independently verified in this build.",
  },
  {
    id: "joe-and-bella-adaptive-collection",
    brandId: "joe-and-bella",
    brandName: "Joe & Bella",
    name: "Senior & Caregiver Adaptive Range",
    productType: "Collection",
    gender: "Unisex",
    category: "Adaptive Clothing",
    productUrl: "https://www.joeandbella.com/",
    imageUrl: null,
    singaporeAvailability: "Singapore availability unknown",
    adaptiveFeatures: ["Magnetic / snap closures", "Easy dressing", "Caregiver-friendly"],
    bestFor: ["Elderly users", "Caregivers", "Seated wear"],
    sourceNotes:
      "Brand-level listing for a US adaptive brand for seniors and caregivers. Singapore shipping unknown; exact product page, price and image not independently verified in this build.",
  },
];
